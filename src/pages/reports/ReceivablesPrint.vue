        ...
        <table class="report-table">
          ...
          <tbody>
            <tr v-if="report.length === 0">
              <td colspan="7" class="text-center text-muted">Tidak ada data piutang outstanding</td>
            </tr>
...
const loadData = async () => {
  ...
  try {
    ...
    const res = await api.get('/reports/receivables', { params: { date_from: dateFrom.value, date_to: dateTo.value } })
